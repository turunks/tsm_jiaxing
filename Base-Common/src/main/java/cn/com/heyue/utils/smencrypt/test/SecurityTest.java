package cn.com.heyue.utils.smencrypt.test;

import cn.com.heyue.utils.smencrypt.Util;
import cn.com.heyue.utils.smencrypt.sm2.SM2EncDecUtils;
import cn.com.heyue.utils.smencrypt.sm2.SM2SignVO;
import cn.com.heyue.utils.smencrypt.sm2.SM2SignVerUtils;
import cn.com.heyue.utils.smencrypt.sm4.SM4Util;
import cn.com.heyue.utils.smencrypt.sm4.SM4UtilsBak;
...
//
//        /*String plainText = "{\"dealDateTime\":\"20201013155823\",\"validDate\":\"20201231\"}";
//        String s = Util.byteToHex(plainText.getBytes());
//        System.out.println("编码填充：" + s);
//        SM4UtilsBak sm4 = new SM4UtilsBak();
//        sm4.secretKey = "00000000000000000000000000000000";
//        sm4.hexString = false;
//
//        System.out.println("ECB模式加密");
...
//
//        sm4.hexString = true;
//        plainText = sm4.decryptData_ECB(cipherText,true);
//        System.out.println("明文: " + plainText);
//        System.out.println("");*/
//
//
//        //String plainText = "55f2a0b2577348ce92addc99aa447460";
...
//
//        System.out.println("ECB模式加密");
//        String cipherText = sm4.encryptData_ECB(plainText,false);
//        System.out.println("密文: " + cipherText);
//        System.out.println("");
//
//        sm4.hexString = true;
//        plainText = sm4.decryptData_ECB(cipherText,false);
//        System.out.println("明文: " + plainText);
//        System.out.println("");
//    }
    ...
    public static void main(String[] args) throws IOException {
        //Cipher cipher = CipherManager.getInstance();

        String s = "2020202020202020202020202020202020202020";
        System.out.println(new String(Hex.decode(s)));

        String sm4 = "5FD898095770DB166957D2428A527942";//sm4密文
        String sm4Key = "A1808C707646F102026ED0F86BFB5EC4";
        String minwen = SM4Util.decryptByEcb(sm4,sm4Key,false);
        System.out.println(minwen);//3dc7cedb9578e6ccc25089ac5556a5c0


        System.out.println(SM4Util.encryptByEcb("00000000000000000000000000000000",minwen,false));
    }
}
