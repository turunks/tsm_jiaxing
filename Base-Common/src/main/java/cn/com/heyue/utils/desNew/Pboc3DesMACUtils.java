package cn.com.heyue.utils.desNew;
 ...
 * @author fuzuyuan
 * @Description
 * @create 2020-11-12 1:35 上午
 */
public class Pboc3DesMACUtils {
    public static byte[] ZERO_IVC = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 };
    /**
    ...
    public static void main(String[] args) throws Exception{
        String data = "841301001C48A30CBBE7E3FFD70112AF605A5DFADD0A470E5462A7FF82800000";
        String key = "00000000000000000000000000000000";
        ZERO_IVC = HexStringUtils.str2HexByte("4156B52B00000000");
        String result = HexStringUtils.bytesToHexString(Pboc3DesMACUtils.calculatePboc3desMAC(HexStringUtils.str2HexByte(data),HexStringUtils.str2HexByte(key),ZERO_IVC));
