...
public class PBOC3DES {
    ...
    public static void main(String[] args) {
        ...
        String result = PBOC_3DES_MAC("841301001C48A30CBBE7E3FFD70112AF605A5DFADD0A470E5462A7FF82800000","00000000000000000000000000000000",HEX);
     ...
     * @param key 密钥(32byte) 32383536393931313238353639393131
     * @param data 数据
     * @param type  HEX:16进制的数据    ASC：字符串
     * @return mac
     */
    public static String PBOC_3DES_MAC(String data, String key,int type){
        String vector = "4156B52B00000000";  //初始向量0000000000000000
        if (key.length()!=32){
            return null;
        }
        if (type == ASC) {
...
//     * @return
//     */
//    public static byte[] PBOC_3DES_MAC_D(byte[] shuju, byte[] key){
//        try {
//            //数据数组总长度
//            int intShujuLen = shuju.length;
//            //解密后数组
//            byte[] bytReturn = new byte[intShujuLen];
//            //取数组key前8字节做密钥1
...
//            }
//            //DES解密
//            bytReturn = PBOC_DES_MAC_D(shuju, Lkey, 2);
//            //DES加密
//            shuju = PBOC_DES_MAC_D(bytReturn, Rkey, 1);
//            //DES解密
//            bytReturn = PBOC_DES_MAC_D(shuju, Lkey, 2);
//            return bytReturn;
//        } catch (Exception e) {
...
//     * @return
//     */
//    public static byte[] PBOC_DES_MAC_D(byte[] shuju, byte[] key, int bFlag)
//    {
//        try {
//            //数据数组总长度
//            int intShujuLen = shuju.length;
//            //处理后数组
//            byte[] bytReturnDES = new byte[intShujuLen];
//            //处理加密/解密标志
//            if (bFlag != 2)
//            {
//                bFlag = 1;
...
//            if (intShujuLen % 8 != 0)
//            {
//                intShujuLen = ((intShujuLen / 8) + 1) * 8;
//            }
//            //8个字节一块，按块解密后顺序连接
//            int intStartIndex = 0;
//            int intEndIndex = 0;
//            byte[] bytTmp = new byte[8];
//            byte[] bytTmpX = new byte[8];
//            do
//            {
//                intEndIndex = intStartIndex + 7;
//                if (intEndIndex >= shuju.length)
//                {
...
//                {
//                    bytTmp[i - intStartIndex] = shuju[i];
//                }
//                //解密
//                if (bFlag == 2)
//                {
//                    try {
//                        bytTmpX = DES.SDecrypt_DES(bytTmp, key);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                }
...
//                {
//                    try {
//                        bytTmpX = DES.SEncrypt_DES(bytTmp, key);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                }
//                for (int i = 0; i < 8; i++)
//                {
//                    bytReturnDES[i + intStartIndex] = bytTmpX[i];
//                }
//                intStartIndex += 8;
//            } while (intStartIndex < shuju.length);
//            return bytReturnDES;
//        } catch (Exception e) {
//            throw e;
//        }
